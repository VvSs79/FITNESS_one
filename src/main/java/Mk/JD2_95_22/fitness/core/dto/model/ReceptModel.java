...
public class ReceptModel {
    ...
    public ReceptModel(UUID uuid, Instant dt_create, Instant dt_update, String title, List<IngridientsModel> composition, Integer weight, Integer calories, Double proteins, Double fats, Double carbohydrates) {
        this.uuid = uuid;
